...
def main():
    ...
    # 远程更新检查地址 (始终指向最新版本, 发版时更新仓库根目录 version.json 即可)
    UPDATE_URL = "https://raw.githubusercontent.com/Franhihy/PCS_Caculating_PlatForm/master/version.json"
    app.setStyle("Fusion")
    ...
    class MainWindow(QMainWindow):
        ...
        def __init__(self):
            super().__init__()
            self.setWindowTitle("PCS计算平台 v1.0.5 - PCS Computing Platform")
        ...
        def _show_about(self):
            ...
            <h2>PCS计算平台 v1.0.5</h2>
            <p><b>PCS Computing Platform</b></p>
            <p>电力电子变换器设计计算平台</p>
            <hr><p><b>版本更新记录:</b></p>
            <p><b>v1.0.5</b> (2026-06-10)</p>
            <ul>
